...
| Dual environment amendment   | separate Compose projects/env/DB/document volumes/secrets/backups | static Compose render + VPS isolation checklist                |
| Migration environment safety | persistent DB marker + pre-migration guard                        | mismatch stops staging before migration/app                    |
| Shared ingress               | edge owns 80/443; hostname routing configurable                   | inspect ports/networks; route smoke test                       |
