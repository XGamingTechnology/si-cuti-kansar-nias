...
Status: **AUTH-001 disetujui; keputusan blocking lain masih menunggu dan M1 belum disetujui**
...
- **DEP-001, DEP-002**: target deployment serta backup/DR masih menentukan fondasi teknis dan
  operasi. Fondasi provider autentikasi telah diputuskan melalui AUTH-001, tetapi detail keamanan
  lokal yang tercatat pada baris tersebut harus ditetapkan sebelum implementasi terkait.
