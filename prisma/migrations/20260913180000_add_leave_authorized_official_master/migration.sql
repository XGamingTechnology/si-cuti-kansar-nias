-- Additive effective-dated master for officials authorized to grant leave.
...
CREATE INDEX "LeaveAuthorizedOfficialAssignment_effectiveFrom_idx"
  ON "LeaveAuthorizedOfficialAssignment"("effectiveFrom");
CREATE INDEX "LeaveAuthorizedOfficialAssignment_effectiveTo_idx"
  ON "LeaveAuthorizedOfficialAssignment"("effectiveTo");
